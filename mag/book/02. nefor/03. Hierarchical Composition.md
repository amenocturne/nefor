...
Ordinary MAG functions can return nodes containing lower-level capability actors, topology junctions, and
...
mechanics. Lowering expands executable capabilities into actors and structural composition into junctions and routes while
...
activation. Parent-owned junctions still remain distinct when their typed
