...
do
  local cases = {
    ...
    { "bash", { label = "Run command", primary = { arg = "command" }, arguments = { { label = "in", arg = "cwd" }, { label = "timeout ms", arg = "timeout_ms" } }, result = { kind = "content" } }, { command = "rg TODO", cwd = "repo", stdin = "PRIVATE" }, "rg TODO" },
